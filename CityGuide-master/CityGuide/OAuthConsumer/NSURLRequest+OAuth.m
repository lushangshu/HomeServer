...
static NSString * const kConsumerKey       = @"2Hs8wbYVdC6rYHpC3AoOYw";
static NSString * const kConsumerSecret    = @"sZRTixkOYW_xkVuOZB4qYAuvQLU";
static NSString * const kToken             = @"MbloucFuosRN-NRm8RYDJhqduzIgT_t5";
static NSString * const kTokenSecret       = @"ORpK7ByZINf5SmWCGq462cBkDc4";
